...
namespace SimulatedDevice
{
    ...
    internal class Program
    {
        ...
        private static string s_connectionString = "INSERT-CONNECTION-STRING-HERE";
        ...
        private static async Task SendDeviceToCloudMessagesAsync(CancellationToken ct)
        {
            ...
            double minNetPing = 20;
            double minRefreshRate = 60;
            var rand = new Random();

            while (!ct.IsCancellationRequested)
            {
                double net_ping = minNetPing + rand.NextDouble() * 15;
                double refresh_rate = minRefreshRate + rand.NextDouble() * 20;
